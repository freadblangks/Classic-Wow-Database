...
$DB = DbSimple_Generic::connect("mysqli://".$AoWoWconf['mangos']['user'].":".$AoWoWconf['mangos']['pass']."@".$AoWoWconf['mangos']['host']."/".$AoWoWconf['mangos']['db']);
...
if($AoWoWconf['realmd'])
{
	$rDB = DbSimple_Generic::connect("mysqli://".$AoWoWconf['realmd']['user'].":".$AoWoWconf['realmd']['pass']."@".$AoWoWconf['realmd']['host']."/".$AoWoWconf['realmd']['db']);
